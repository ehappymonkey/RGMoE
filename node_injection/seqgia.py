from attack import deg_estimate, edge_sim_estimate, gcn_norm, gia_update_features, init_feat, node_sim_estimate, smooth_update_features
from injection import agia_injection, meta_injection, random_class_injection, random_injection, tdgia_injection, tdgia_ranking_select, atdgia_injection, atdgia_ranking_select
import random
...
class SEQGIA(object):
    ...
    def __init__(self,
                 epsilon, # attack_lr=0.01
                 n_epoch, # attack_epoch=500
                 a_epoch, # agia_epoch=300
                 n_inject_max, # n_inject_max=60 for cora
                 n_edge_max, # n_edge_max=20 for cora
                 feat_lim_min, # feat_lim_min=-1
                 feat_lim_max, # feat_lim_max=1
                 injection="random",
                 device='cpu',
                 loss=F.nll_loss,
