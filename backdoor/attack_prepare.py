...
from torch_geometric.datasets import Planetoid,Reddit2,Flickr,Coauthor
...
# Training settings
from attack_utils import set_seed, parse_args
...
data, poison_x, poison_edge_index, poison_edge_weights, poison_labels, idx_attach, bkd_tn_nodes, idx_val, idx_clean_test, idx_atk, mask_edge_index, model = prepare_attack() 
...
if args.use_vs_number:
    save_filename = f"{args.dataset}_{args.vs_number}_{args.selection_method}_" \
                    f"{args.defense_mode}_{args.attack_method}_backdoor_attack.pth"
else:
